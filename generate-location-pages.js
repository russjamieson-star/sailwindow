...
const STATIONS = {
  ...
  "marathon": { name: "Marathon, FL", stationId: "8723970" },
  "islamorada": { name: "Islamorada, FL", stationId: "8723808" },
  "miami": { name: "Miami Beach, FL", stationId: "8723170" },
  "fort-lauderdale": { name: "Fort Lauderdale, FL", stationId: "8722956" },
  "west-palm-beach": { name: "West Palm Beach, FL", stationId: "8722670" },
  "jupiter": { name: "Jupiter, FL", stationId: "8722495" },
  "stuart": { name: "Stuart, FL", stationId: "8722357" },
  "fort-pierce": { name: "Fort Pierce, FL", stationId: "8722212" },
  "vero-beach": { name: "Vero Beach, FL", stationId: "8722125" },
  "cocoa": { name: "Cocoa, FL", stationId: "8721649" },
  "port-canaveral": { name: "Port Canaveral, FL", stationId: "8721604" },
  "daytona": { name: "Daytona Beach, FL", stationId: "8721120" },
  "st-augustine": { name: "St. Augustine, FL", stationId: "8720576" },
  "jacksonville": { name: "Jacksonville, FL", stationId: "8720218" },
  "fernandina": { name: "Fernandina Beach, FL", stationId: "8720030" },
  "marco-island": { name: "Marco Island, FL", stationId: "8724967" },
  "naples": { name: "Naples, FL", stationId: "8725110" },
  "fort-myers": { name: "Fort Myers, FL", stationId: "8725520" },
  "punta-gorda": { name: "Punta Gorda, FL", stationId: "8725744" },
  "sarasota": { name: "Sarasota, FL", stationId: "8726083" },
  ...
  "port-st-joe": { name: "Port St. Joe, FL", stationId: "8728912" },
  ...
  "port-bolivar": { name: "Port Bolivar, TX", stationId: "8771328" },
  "kemah": { name: "Kemah / Clear Lake, TX", stationId: "8770933" },
  "galveston": { name: "Galveston Pier 21, TX", stationId: "8771450" },
  "freeport": { name: "Freeport, TX", stationId: "8772447" },
  "port-lavaca": { name: "Port Lavaca, TX", stationId: "8773259" },
  ...
  "port-aransas": { name: "Port Aransas, TX", stationId: "8775237" },
  "corpus-christi": { name: "Corpus Christi, TX", stationId: "8775870" },
  "port-mansfield": { name: "Port Mansfield, TX", stationId: "8778485" },
  "port-isabel": { name: "Port Isabel, TX", stationId: "8779770" },
  "south-padre-island": { name: "South Padre Island, TX", stationId: "8779748" }
};
